    ...
    <div ref={wrapperRef} style={{ position: "relative" }}>
      <div style={{ position: "relative" }}>
        <input
          ...
          placeholder="Buscá un medicamento... ej: Tafirol, Amoxicilina"
          style={inputStyle}
          onFocus={(e) => {
        ...
        >
          {results.map((m) => (
            <div
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = "rgba(10,230,199,0.07)")
              }
              onMouseLeave={(e) =>
            ...
            >
              ...
              >
                {[m.principio_activo_str, m.forma, m.laboratorio]
                  .filter(Boolean)
                  .join(" · ")}
              </div>
            </div>
